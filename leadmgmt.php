<?php
/**
 * Template Name: Custom template for leadmgmt
 */
...
<div id="Consultationmotive" class="tabcontent">
	...
	<img src="/wp-content/uploads/2023/05/mobile-siderbar.png" class="firsttabbg-mb2">
	 <p class="mobilesecondtab-title"> Next: Meeting preference</p>
...
<span class="ferperservtitle"> 
  ...
  <label for="FH">Learning more about<br>fertility health<img src="/wp-content/uploads/2023/05/lead-mgmt-learnmore-330x230.jpeg"></label></span><br><br>
	...
	<div><img src="/wp-content/uploads/2023/05/Mask-group-4.png" class="firsttabbg-image">
	<!-- <img src="/wp-content/uploads/2023/05/mobile-siderbar.png" class="firsttabbg-mb1"> -->
	</div>
	   <div class="prevCls">
	  ...
	  <button type="button" class="skip">Skip</button>
	  <button type="button" id="consultationNext" disabled="disabled">Share appointment motive  </button>
	</div>
	  <div class="clearfix"></div>
</div>
...
<div id="Doctorspreference" class="tabcontent">
   ...
   <p class="mobilethirdtab-title">Next: Personal info & submit</p>
		<p class="stafffromplace">Show me staff from:</p>
...
<label class="tablinks dubai loca-dubaibutton" onclick="getLocationDoctors(event, 'dubai')"><input class="cityName" type="radio" id="Abudhabi" name="staffCity" value="Abu Dhabi"> <img width='15' height='22' src="../../../wp-content/uploads/2023/04/location-map.svg" alt="Right arrow"> Dubai</label>
<label class="tablinks abudhabi loca-abudubaibutton" onclick="getLocationDoctors(event,'abu-dhabi')"><input class="cityName" type="radio" id="dubai" name="staffCity" value="Dubai"><img width='15' height='22' src="../../../wp-content/uploads/2023/04/location-map.svg" alt="Right arrow">Abu Dhabi</label>
<label class="tablinks loca-alainbutton" onclick="getLocationDoctors(event, 'al-ain')"><input class="cityName" type="radio" id="Alain" name="staffCity" value="Al Ain"><img width='15' height='22' src="../../../wp-content/uploads/2023/04/location-map.svg" alt="Right arrow">Al Ain</label>
</div>
...
<label for="travelDate" class="knowyourtravel">Please let us know your travel date to our clinic</label>
  <input type="text" id="travelDate" name="travelDate"><br><br>
	...
	<button type="button" class="previous backfirsttab1">Edit previous response</button>
	  ...
	  <button type="button" class="skip">Skip</button>
	  <button type="button" id="consultWith" disabled="disabled">Confirm preferences</button>
	</div>
	<div>
